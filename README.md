# Bacterial Foraging Optimization (BFO) — Demo Repository

Ce dépôt contient une implémentation pédagogique du **Bacterial Foraging Optimization (BFO)** et des utilitaires pour visualiser les résultats.
